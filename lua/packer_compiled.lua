...
_G.packer_plugins = {
  ...
  ["cool-substitute.nvim"] = {
    config = { "require('config.cool')" },
    loaded = true,
    path = "/Users/nathan/.local/share/nvim/site/pack/packer/start/cool-substitute.nvim",
  ...
  ["nvim-retrail"] = {
    config = { "require('config.retrail')" },
    loaded = true,
    path = "/Users/nathan/.local/share/nvim/site/pack/packer/start/nvim-retrail",
  ...
  tabular = {
    loaded = true,
    path = "/Users/nathan/.local/share/nvim/site/pack/packer/start/tabular",
  ...
  ["vim-arduino"] = {
    loaded = true,
    path = "/Users/nathan/.local/share/nvim/site/pack/packer/start/vim-arduino",
...
pcall(vim.api.nvim_create_user_command, 'FormatWrite', function(cmdargs)
          require('packer.load')({'formatter.nvim'}, { cmd = 'FormatWrite', l1 = cmdargs.line1, l2 = cmdargs.line2, bang = cmdargs.bang, args = cmdargs.args, mods = cmdargs.mods }, _G.packer_plugins)
        end,
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'formatter.nvim'}, { cmd = 'FormatWrite' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'Pydocstring', function(cmdargs)
          require('packer.load')({'vim-pydocstring'}, { cmd = 'Pydocstring', l1 = cmdargs.line1, l2 = cmdargs.line2, bang = cmdargs.bang, args = cmdargs.args, mods = cmdargs.mods }, _G.packer_plugins)
        end,
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vim-pydocstring'}, { cmd = 'Pydocstring' }, _G.packer_plugins)
          return vim.fn.getcompletion('Pydocstring ', 'cmdline')
      end})
...
pcall(vim.api.nvim_create_user_command, 'SudoEdit', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vim-eunuch'}, { cmd = 'SudoEdit' }, _G.packer_plugins)
